...
const MyProfile = () => {
    ...
    useEffect(() => {
        const apiCall = setTimeout(() => {
            axios.get("https://api.github.com/users/piyushyadav0191").then((res) => setData(res.data));
            axios.get("https://api.github.com/users/piyushyadav0191/repos").then((res) => setRepos(res.data));
        }, 1500);
                            ...
                            <div className="card-body flex items-center p-0 sm:p-5">
                                ...
                                <div className="badges my-1 flex w-full justify-evenly flex-wrap">
                                    <div className="badge badge-primary cursor-pointer ">
                                        <a href="https://github.com/piyushyadav0191?tab=repositories">
                                            <b>Repos: {data.public_repos}</b>
                                        </a>
                                    </div>
                                    <div className="badge badge-secondary cursor-pointer ">
                                        <a href="https://github.com/piyushyadav0191?tab=followers">
                                            <b>Followers {data.followers}</b>
                                        </a>
                                    </div>
                                    <div className="badge badge-accent cursor-pointer">
                                        <a href="https://github.com/piyushyadav0191?tab=following">
